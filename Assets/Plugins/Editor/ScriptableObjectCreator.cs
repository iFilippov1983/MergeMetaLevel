...
{
    private static HashSet<Type> scriptableObjectTypes = CreateTypes();

    private static HashSet<Type> CreateTypes()
    {
        IEnumerable<Type> iEnumerable = AssemblyUtilities
        ...
        return new HashSet<Type>(iEnumerable, null);
    }
    ...
    private void CreateAsset()
    {
        if (this.previewObject)
        {
            ...
            var name =  this.MenuTree.Selection.First().Name.Replace(" ", String.Empty);
