...
//            hideFlags = HideFlags.HideInInspector;
        ...
        public void Clear()
        {
            ...
            _activeVertexTweens = null;
            _activeColorTweens = null;
            proxyTransforms = null;
            proxyColors = null;
        ...
        // Helper for method chaining
        public Transform GetProxyTransform(int charIndex)
        {
...
//            t.gameObject.hideFlags = HideFlags.HideAndDontSave;
        ...
        public void SetAlpha2(int charIndex, float alpha)
        {
            GetProxyColor(charIndex).SetAlpha(alpha);
        }
