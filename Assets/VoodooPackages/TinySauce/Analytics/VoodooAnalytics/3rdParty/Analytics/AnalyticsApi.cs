 ...
 namespace Voodoo.Analytics
{
    internal static class AnalyticsApi
    {
        ...
        private static readonly string AnalyticsGatewayUrl = GetURL("https://vs-api.voodoo-{0}.io/push-analytics", Sauce.Internal.EnvironmentSettings.EnvironmentSettings.Api.Analytics);
