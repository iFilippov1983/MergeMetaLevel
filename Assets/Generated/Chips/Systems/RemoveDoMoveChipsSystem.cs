...
public sealed class RemoveDoMoveChipsSystem : ICleanupSystem {

    readonly IGroup<ChipsEntity> _group;
    readonly List<ChipsEntity> _buffer = new List<ChipsEntity>();

    public RemoveDoMoveChipsSystem(Contexts contexts) {
        _group = contexts.chips.GetGroup(ChipsMatcher.DoMove);
    }
