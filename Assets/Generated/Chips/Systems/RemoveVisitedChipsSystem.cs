...
public sealed class RemoveVisitedChipsSystem : ICleanupSystem {

    readonly IGroup<ChipsEntity> _group;
    readonly List<ChipsEntity> _buffer = new List<ChipsEntity>();

    public RemoveVisitedChipsSystem(Contexts contexts) {
        _group = contexts.chips.GetGroup(ChipsMatcher.Visited);
    }
