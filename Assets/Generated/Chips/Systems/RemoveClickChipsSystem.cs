...
public sealed class RemoveClickChipsSystem : ICleanupSystem {

    readonly IGroup<ChipsEntity> _group;
    readonly List<ChipsEntity> _buffer = new List<ChipsEntity>();

    public RemoveClickChipsSystem(Contexts contexts) {
        _group = contexts.chips.GetGroup(ChipsMatcher.Click);
    }
